...
assert.equal(manifest.name, "My Daily Devotion"); assert.equal(manifest.start_url, "./#/today"); assert.equal(manifest.scope, "./"); assert.equal(manifest.display, "standalone"); assert.equal(manifest.background_color, "#f4f0e6"); assert.equal(manifest.theme_color, "#f4f0e6");
