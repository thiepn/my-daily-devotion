...
const css = [tokens, base, shell, screens, scripture, phase4, phase5, phase6, phase7].join("\n");
...
for (const importPath of ["tokens.css", "base.css", "shell.css", "screens.css", "scripture.css", "phase4.css", "phase5.css", "phase6.css", "phase7.css"]) assert.ok(main.includes(importPath), `main.tsx must import ${importPath}`);
