...
assert.equal(visual.character, "quiet-editorial-reading-journal");
assert.equal(visual.typography.remoteFontDependency, false);
...
for (const label of ["Today", "Bible", "Prayer", "History"]) {
