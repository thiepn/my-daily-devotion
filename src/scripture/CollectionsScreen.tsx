...
export function CollectionsScreen() {
  ...
  return <main className="visual-screen collections-screen"><header className="screen-heading compact-heading"><p className="eyebrow">Bible · Saved</p><h1>Collections</h1><p className="screen-intro">Keep meaningful passages together.</p><div className="quiet-link-row"><Link to="/bible">← Bible</Link><Link to="/search">Search</Link>{returnTo?.startsWith("/") && !returnTo.startsWith("//") ? <Link to={returnTo}>Back to passage</Link> : null}</div></header>
