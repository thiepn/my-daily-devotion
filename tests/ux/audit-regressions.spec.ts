...
test("encrypted backup restores in a fresh profile and failed/cancelled restores preserve data", async ({ page, browser }) => {
...
test("invalid, deleted and failed lazy routes have recoverable states", async ({ page }) => {
...
test("populated dark forms and Scripture remain accessible with long text", async ({ page }) => {
